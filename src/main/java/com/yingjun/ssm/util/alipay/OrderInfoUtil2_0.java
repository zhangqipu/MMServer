...
import com.yingjun.ssm.util.alipay.SignUtils;
...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2, String subject, String body, String totalAmount, String outTradeNo) {
		Map<String, String> keyValues = new HashMap<String, String>();
